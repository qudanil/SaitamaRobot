...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "Never gonna give {mention} up. Never gonna let {first} down.",
    ...
    "A new Challenger enters!, its {mention}",  # Tekken
    "Welcome {mention}, Im Meguri",
    ...
    "I'm looking for Garo, oh wait nvm it's {mention}.",  # One Punch man s2
    "Welcome {mention}, leaving is not an option!",
    "Run Forest! ..I mean...{mention}.",
    "{mention} do 100 push-ups, 100 sit-ups, 100 squats, and 10km running EVERY SINGLE DAY!!!",  # One Punch ma
    "Huh?\nDid someone with a disaster level just join?\nOh wait, it's just {mention}.",  # One Punch ma
    "Hey, {mention}, ever heard the King Engine?",  # One Punch ma
    ...
    "{mention} … mukatta kuruno ka?",  # jojo jap ver
    ...
    "{mention} Rerorerorerorerorero.",  # jojo
    ...
    "Hey {mention}, Remember, remember, the Fifth of November, the Gunpowder Treason and Plot. I know of no reason why the Gunpowder Treason should ever be forgot.", #V for Vendetta
